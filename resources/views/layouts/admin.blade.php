        ...
        <div id="sidebar" class="sidebar sidebar-with-footer">
            ...
            <div class="app-brand">
                <a href="/home">
                    ...
                    <span class="brand-name">Dashboard Home</span>
                </a>
            </div>
            ...
            <div class="sidebar-left" data-simplebar style="height: 100%;">
                ...
                <ul class="nav sidebar-inner" id="sidebar-menu">
                    ...
                    <li>
                        <a class="sidenav-item-link" href="/admin/options">
                            <i class="mdi mdi-chart-line"></i>
                    ...
                    <ul class="nav navbar-nav">
                                ...
                                <div class="" data-simplebar style="height: 325px;">
                                            ...
                                            <div class="media media-sm bg-warning-10 p-4 mb-0">
                                                <div class="media-sm-wrapper">
                                                    <a href="user-profile.html">
                                                        <img src="{{asset('assets/admin/')}}/images/user/user-sm-02.jpg"
                                                             alt="User Image">
                                                    </a>
                                                </div>
                                    ...
                                    <time>10 min ago...</time>...
                                            ...
                                            <div class="media media-sm p-4 mb-0">
                                                <div class="media-sm-wrapper">
                                                    <a href="user-profile.html">
                                                        <img src="{{asset('assets/admin/')}}/images/user/user-sm-03.jpg"
                                                             alt="User Image">
                                                    </a>
                                                </div>
                                                <div class="media-body">
                                            ...
                                            <div class="media media-sm p-4 mb-0">
                                                ...
                                                <div class="media-body">
                                                    <a href="user-profile.html">
                                                        ...
                                                        <span
                                                            class="discribe">Afraid at highly months do things on at.</span>
                                                        <span class="time">
                                    <time>1 hrs ago</time>...
                                  </span>
                                                    </a>
                                        ...
                                        <div class="tab-pane fade" id="message" role="tabpanel"
                                            ...
                                            <div class="media media-sm p-4 mb-0">
                                                <div class="media-sm-wrapper">
                                                    <a href="user-profile.html">
                                                        <img src="{{asset('assets/admin/')}}/images/user/user-sm-01.jpg"
                                                             alt="User Image">
                                                    </a>
                                                </div>
                                                <div class="media-body">
                                    ...
                                    <time>Just now</time>...
                                            ...
                                            <div class="media media-sm p-4 mb-0">
                                                <div class="media-sm-wrapper">
                                                    <a href="user-profile.html">
                                                        <img src="{{asset('assets/admin')}}/images/user/user-sm-04.jpg"
                                                             alt="User Image">
                                                    </a>
                                                </div>
                                                <div class="media-body">
                        ...
                        <li class="dropdown user-menu">
                            <button class="dropdown-toggle nav-link" data-toggle="dropdown">
                                <img src="{{ asset('assets/admin/') }}/images/user/user-xs-01.jpg"
